...
unsigned int MarkSweep::count_objs = 0;
...
void MarkSweep::AdjustPointerClosure::do_oop(oop* p)       { adjust_pointer(NULL,p); }
void MarkSweep::AdjustPointerClosure::do_oop(narrowOop* p) { adjust_pointer(NULL,p); }
