...
#define InstanceMirrorKlass_SPECIALIZED_UPDATE_OOP_ITERATE( \
...
#define InstanceMirrorKlass_OOP_ITERATE(obj, start_p, count,    \
                                  do_oop, assert_fn)       \
{                                                          \
  if (UseCompressedOops) {                                 \
    ...
    InstanceMirrorKlass_SPECIALIZED_UPDATE_OOP_ITERATE(obj, oop,       \
      start_p, count,                                      \
      do_oop, assert_fn)                                   \
  }                                                        \
}
...
void InstanceMirrorKlass::oop_follow_contents(oop obj) {
	...
	if (EnableTeraCache && obj->is_tera_cache()) {
		InstanceMirrorKlass_OOP_ITERATE(                       \
				obj,start_of_static_fields(obj),                   \
...
void InstanceMirrorKlass::oop_follow_contents(ParCompactionManager* cm,
  ...
  InstanceMirrorKlass_OOP_ITERATE(                                                    \
    obj, start_of_static_fields(obj), java_lang_Class::static_oop_field_count(obj),        \
