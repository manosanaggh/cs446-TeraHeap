...
#define DEBUG_PAR_OLD_MARKING    0

#define DEBUG_PAR_OLD_PRECOMPACT 0

#define DEBUG_TC_SCAVENGE	 0

#define DEBUG_TC_PAR_ADJUST	 0

#define DEBUG_PAR_OLD_UPDATE_CONTENTS 0

#define DEBUG_PAR_OLD_COMPACT    0

#define DISABLE_TERACACHE		 0  //< Disable teraCache

#define DISABLE_TC_PAR_OLD               0

#define DISABLE_PRECOMPACT		 0  //< Disable precompact of tera objects

#define IGNORE_TERA		 	 1

#define DISABLE_PO_PRECOMPACT		 0

#define DISABLE_PO_ADJUST		 0

#define DISABLE_PO_COMPACT		 0

#define PARALLEL_TC		         0

#define PS_LOCAL_LOCK			 0

#define PARALLEL_MARKING_VECTOR		 1

#define PARALLEL_MARKING_SET		 0

#define DISABLE_LOGGING			 0

#define MARK_TERA_CT_FIX		 1
